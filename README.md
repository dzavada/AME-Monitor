...
![Dashboard overview — all machines on one page](ame-monitor/images/dashboard-overview.png)
...
![Machine card — active encode with thumbnail, progress and watch-folder counts](ame-monitor/images/dashboard-detail-1.png)
...
![Machine card — queue, health meters and controls](ame-monitor/images/dashboard-detail-2.png)
